...
export async function sendPlayerInvitationEmail({
  ...
  const htmlContent = `
    ...
    <body style="margin:0; padding:24px; background-color:#090d16; font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; color:#e2e8f0;">
      <div style="max-width:560px; margin:0 auto; background-color:#111827; border:1px solid #1e293b; border-radius:16px; padding:32px; box-shadow:0 10px 25px -5px rgba(0,0,0,0.5);">
        
        <div style="font-size:22px; font-weight:800; color:#3b82f6; letter-spacing:-0.5px; margin-bottom:20px;">
          Club<span style="color:#ffffff;">Lab</span>
        </div>
        
        <div style="display:inline-block; background-color:rgba(16,185,129,0.15); color:#34d399; border:1px solid rgba(16,185,129,0.3); font-size:11px; font-weight:700; text-transform:uppercase; padding:4px 10px; border-radius:9999px; margin-bottom:16px;">
          📩 Invitación Oficial
        </div>
        
        <h2 style="color:#ffffff; font-size:20px; margin:0 0 12px 0; font-weight:700;">¡Te han invitado a unirte a ${orgName}!</h2>
        
        <p style="color:#cbd5e1; font-size:14px; line-height:1.6; margin:0 0 16px 0;">Hola <strong>${recipientName}</strong>,</p>
        <p style="color:#cbd5e1; font-size:14px; line-height:1.6; margin:0 0 16px 0;">Has recibido una invitación para darte de alta en la plataforma <strong>ClubLab</strong> con el rol de <strong>${roleName}</strong>.</p>
        <p style="color:#cbd5e1; font-size:14px; line-height:1.6; margin:0 0 24px 0;">Al registrarte, tu cuenta se vinculará automáticamente con tu ficha en la plantilla del club y podrás acceder a tu perfil y entrenamientos.</p>
        
        <div style="margin:28px 0 24px 0; text-align:left;">
          <a href="${invitationUrl}" target="_blank" style="display:inline-block; background-color:#10b981; color:#ffffff !important; font-size:14px; font-weight:700; text-decoration:none; padding:14px 28px; border-radius:10px; box-shadow:0 4px 14px rgba(16,185,129,0.35);">
            Completar Registro en ClubLab &rarr;
          </a>
        </div>

        <p style="font-size:12px; color:#64748b; margin:16px 0;">Si el botón no funciona, copia este enlace en tu navegador:<br><a href="${invitationUrl}" style="color:#38bdf8; text-decoration:underline; word-break:break-all;">${invitationUrl}</a></p>
        
        <div style="margin-top:32px; border-top:1px solid #1e293b; padding-top:20px; font-size:11px; color:#64748b; text-align:center;">
          Mensaje automático generado desde la plataforma <strong>ClubLab</strong>.<br>No respondas directamente a este correo.
        </div>
