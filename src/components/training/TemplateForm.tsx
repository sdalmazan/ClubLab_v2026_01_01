                  ...
                  <div className="border-t border-white/5 pt-4">
                    <div className="flex items-center justify-between">
                      ...
                      >
                        ...
                        {hasWhiteboardData(ex.whiteboard_data) ? "Editar Dibujo" : "Dibujar Ejercicio"}
                      </button>
                    </div>
                    {hasWhiteboardData(ex.whiteboard_data) && (
                      <div className="mt-2">
                        {ex.whiteboard_data?.imageDataUrl ? (
                          ...
                          <TacticalSvgRenderer value={ex.whiteboard_data} width={300} height={200} className="w-full max-h-32 rounded-xl border border-white/10 bg-slate-900" />
                        )}
                      </div>
                    )}
                  </div>
