...
export function PlayerBottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 bg-background/95 backdrop-blur-xl border-t border-border/40 px-2 py-2 sm:hidden shadow-2xl pb-[max(0.5rem,env(safe-area-inset-bottom))]">
