// ============================================================
// scrape-segunda.ts — Scraper de Segunda Federación (Playwright Headless)
// ============================================================
// Scrapea e inserta en la base de datos de estadísticas y actualiza la caché
// de scouting para los 5 grupos de Segunda Federación en la temporada 2025/2026.
//
// Uso:
//   npx tsx scripts/scrape-segunda.ts
// ============================================================
...
async function main() {
  console.log("════════════════════════════════════════════════════════");
  console.log("  Scraper de Segunda Federación (RFEF)");
  ...
  for (let idx = 0; idx < targets.length; idx++) {
    ...
    console.log(`\n[Grupo 2ª Fed ${idx + 1}/${targets.length}] Iniciando ${target.competition} (${target.season})...`);
  ...
  console.log("\n════════════════════════════════════════════════════════");
  console.log("  PROCESO DE SCRAPING DE SEGUNDA FEDERACIÓN COMPLETADO");
  console.log("════════════════════════════════════════════════════════\n");
  process.exit(0);
}
