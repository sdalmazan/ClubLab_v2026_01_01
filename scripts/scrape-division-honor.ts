// ============================================================
// scrape-division-honor.ts — Scraper de División de Honor (Playwright Headless)
// ============================================================
// Scrapea e inserta en la base de datos de estadísticas y actualiza la caché
// de scouting para los 5 grupos de División de Honor en la temporada 2025/2026.
//
// Uso:
//   npx tsx scripts/scrape-division-honor.ts
// ============================================================
...
async function main() {
  console.log("════════════════════════════════════════════════════════");
  console.log("  Scraper de División de Honor Juvenil (RFEF)");
  console.log("  Temporada 2025/2026 | Grupos 1 al 5");
  console.log("════════════════════════════════════════════════════════");
  ...
  // Definir los 5 grupos de División de Honor a scrapear
  const targets = [
    { season: "2025/2026", competition: "División de Honor - Grupo 1" },
    { season: "2025/2026", competition: "División de Honor - Grupo 2" },
    { season: "2025/2026", competition: "División de Honor - Grupo 3" },
    { season: "2025/2026", competition: "División de Honor - Grupo 4" },
    { season: "2025/2026", competition: "División de Honor - Grupo 5" },
  ];

  const scraperOptions = {
    delayMatch: 8000,       // 8 segundos de pausa entre descargas de actas
    delayMatchday: 3000,    // 3 segundos de pausa entre jornadas
    maxMatchday: 30,        // 30 jornadas para 16 equipos
    emptyLimit: 4,          // Detenerse tras 4 jornadas vacías consecutivas
  };

  for (let idx = 0; idx < targets.length; idx++) {
    const target = targets[idx];
    console.log(`\n[Grupo DH ${idx + 1}/${targets.length}] Iniciando ${target.competition} (${target.season})...`);
  ...
  console.log("\n════════════════════════════════════════════════════════");
  console.log("  PROCESO DE SCRAPING DE DIVISIÓN DE HONOR COMPLETADO");
  console.log("════════════════════════════════════════════════════════\n");
  process.exit(0);
}
