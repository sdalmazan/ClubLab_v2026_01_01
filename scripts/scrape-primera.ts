// ============================================================
// scrape-primera.ts — Scraper de Primera Federación (Playwright Headless)
// ============================================================
// Scrapea e inserta en la base de datos de estadísticas y actualiza la caché
// de scouting para los 2 grupos de Primera Federación en la temporada 2025/2026.
//
// Uso:
//   npx tsx scripts/scrape-primera.ts
// ============================================================
...
async function main() {
  console.log("════════════════════════════════════════════════════════");
  console.log("  Scraper de Primera Federación (RFEF)");
  console.log("  Temporada 2025/2026 | Grupos 1 y 2");
  console.log("════════════════════════════════════════════════════════");
  ...
  // Definir los grupos y temporadas de Primera Federación a scrapear
  const targets = [
    { season: "2025/2026", competition: "Primera Federación - Grupo 1" },
    { season: "2025/2026", competition: "Primera Federación - Grupo 2" },
    { season: "2024/2025", competition: "Primera Federación - Grupo 1" },
    { season: "2024/2025", competition: "Primera Federación - Grupo 2" },
    { season: "2023/2024", competition: "Primera Federación - Grupo 1" },
    { season: "2023/2024", competition: "Primera Federación - Grupo 2" },
    { season: "2022/2023", competition: "Primera Federación - Grupo 1" },
    { season: "2022/2023", competition: "Primera Federación - Grupo 2" },
    { season: "2021/2022", competition: "Primera Federación - Grupo 1" },
    { season: "2021/2022", competition: "Primera Federación - Grupo 2" },
  ];

  const scraperOptions = {
    delayMatch: 8000,       // 8 segundos de pausa entre descargas de actas
    delayMatchday: 3000,    // 3 segundos de pausa entre jornadas
    maxMatchday: 38,        // 38 jornadas en liga de 20 equipos
    emptyLimit: 4,          // Detenerse tras 4 jornadas vacías consecutivas
  };

  for (let idx = 0; idx < targets.length; idx++) {
    const target = targets[idx];
    console.log(`\n[Grupo 1ª Fed ${idx + 1}/${targets.length}] Iniciando ${target.competition} (${target.season})...`);
    ...
    try {
      ...
      console.log(`\n✓ Grupo finalizado: ${target.competition} (${target.season})`);
  ...
  console.log("\n════════════════════════════════════════════════════════");
  console.log("  PROCESO DE SCRAPING DE PRIMERA FEDERACIÓN COMPLETADO");
  console.log("════════════════════════════════════════════════════════\n");
  process.exit(0);
}
