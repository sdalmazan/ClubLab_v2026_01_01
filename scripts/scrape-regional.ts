// ============================================================
// scrape-regional.ts — Scraper de Primera Regional (Playwright Headless)
// ============================================================
// Scrapea e inserta en la base de datos de estadísticas todos los partidos
// de la 1ª División Regional Aficionados (Grupos A y B) para las temporadas
// 2025/2026 y 2024/2025.
//
// Uso:
//   npx tsx scripts/scrape-regional.ts
// ============================================================
...
async function main() {
  console.log("════════════════════════════════════════════════════════");
  console.log("  Scraper de Primera Regional Aficionados (Castilla y León)");
  console.log("  Temporadas 2025/2026 y 2024/2025 | Grupos A y B");
  console.log("════════════════════════════════════════════════════════");
  ...
  // Definir las 4 competiciones a scrapear
  const targets = [
    { season: "2025/2026", competition: "1ª División Regional Aficionados - Grupo A" },
    { season: "2025/2026", competition: "1ª División Regional Aficionados - Grupo B" },
    { season: "2024/2025", competition: "1ª División Regional Aficionados - Grupo A" },
    { season: "2024/2025", competition: "1ª División Regional Aficionados - Grupo B" },
  ];
  ...
  for (let idx = 0; idx < targets.length; idx++) {
    ...
    console.log(`\n[Competición ${idx + 1}/${targets.length}] Iniciando ${target.competition} (${target.season})...`);
    ...
    try {
      ...
      console.log(`\n✓ Competición finalizada: ${target.competition} (${target.season})`);
  ...
  console.log("\n════════════════════════════════════════════════════════");
  console.log("  PROCESO DE SCRAPING DE REGIONAL COMPLETADO");
  console.log("════════════════════════════════════════════════════════\n");
  process.exit(0);
}
